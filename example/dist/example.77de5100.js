...
},{}],"../auth0/auth.ts":[function(require,module,exports) {
"use strict";
...
exports.logout = exports.login = exports.getAuth0Client = exports.checkSession = exports.checkRedirect = exports.PaackAuthError = exports.NoSessionError = exports.InvalidError = exports.ElmTreatableError = void 0;

function isSuccessUrl(searchParams) {
  return searchParams.has('code') && searchParams.has('state');
}

function isFailureUrl(searchParams) {
  return searchParams.has('error') && searchParams.has('error_description');
}

var ElmTreatableError =
/** @class */
function (_super) {
  __extends(ElmTreatableError, _super);

  function ElmTreatableError(tag, message) {
  ...
  ElmTreatableError.prototype.toJSON = function () {
    return {
      error: this.tag,
  ...
  return ElmTreatableError;
}(Error);

exports.ElmTreatableError = ElmTreatableError;

var PaackAuthError =
/** @class */
function (_super) {
  __extends(PaackAuthError, _super);

  function PaackAuthError(err) {
    return _super.call(this, 'AUTH_FAILED', err.error_description) || this;
  }

  return PaackAuthError;
}(ElmTreatableError);

exports.PaackAuthError = PaackAuthError;

var NoSessionError =
/** @class */
function (_super) {
  __extends(NoSessionError, _super);

  function NoSessionError() {
    return _super.call(this, 'NO_SESSION', 'User is not authenticated') || this;
  }

  return NoSessionError;
}(ElmTreatableError);

exports.NoSessionError = NoSessionError;
...
function (_super) {
  ...
  function InvalidError(err) {
    return _super.call(this, 'INVALID', err.message) || this;
  }
...
function getAuth0Client(clientId, domain, audience) {
  return __awaiter(this, void 0, Promise, function () {
    var ui_locales;
    return __generator(this, function (_a) {
      ui_locales = window.navigator.userLanguage || window.navigator.language || 'es en';
      return [2
      /*return*/
      , createAuth0Client({
        domain: domain,
...
function checkRedirect(client, autoLogin) {
  return __awaiter(this, void 0, Promise, function () {
    var searchParams, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          searchParams = new URLSearchParams(window.location.search);
          if (!(isSuccessUrl(searchParams) || isFailureUrl(searchParams))) return [3
          /*break*/
          , 5];
          _a.label = 1;
        ...
        case 4:
          ...
          if (err_1 instanceof AuthenticationError) {
            throw new PaackAuthError(err_1);
          } else {
            throw new InvalidError(err_1);
          }
...
function checkSession(client, autoLogin) {
  return __awaiter(this, void 0, Promise, function () {
    var isAuthenticated;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
exports.login = login;
},{}],"../auth0/connect.ts":[function(require,module,exports) {
"use strict";
...
exports.connectAppToAuth = void 0;

var auth = __importStar(require("./auth"));

function connectAppToAuth(app, authClient, authAutoLogin) {
  var _this = this;
  ...
  */
  ...
  var callback = function callback(lambda) {
    return function () {
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 1:
              return [4
              /*yield*/
              , _a.apply(void 0, [_b.sent(), authAutoLogin])];
            ...
            case 3:
              err_1 = _b.sent();
              if (err_1 instanceof auth.ElmTreatableError) app.ports.authResult.send(err_1.toJSON());else throw err_1;
              return [3
              /*break*/
              , 4];
...
exports.connectAppToAuth = connectAppToAuth;
},{"./auth":"../auth0/auth.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var Main_elm_1 = require("./src/Main.elm");

var connect_1 = require("../auth0/connect");

var seeds = Array.from(crypto.getRandomValues(new Uint32Array(4)));
...
var clientId = "E4AbG3RwqR2cvRivDZJi6pCU4pVrbNAm";
var domain = "paack-hq-development.eu.auth0.com";
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          authClient = _a.sent();
          connect_1.connectAppToAuth(app, authClient, true);
          return [2
          /*return*/
          ];
      }
...
},{"./src/Main.elm":"src/Main.elm","../auth0/connect":"../auth0/connect.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
